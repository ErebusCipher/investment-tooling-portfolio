    ...
    <div className="max-w-5xl mx-auto px-4 py-16">
      ...
      <div className="mb-20">
        ...
        <p className="text-xl text-zinc-400 max-w-2xl leading-relaxed mb-8">
          Pseudonymous crypto analyst, trader, and builder with experience across trading desks, market structure, DeFi protocols, and AI-assisted research systems. I build tools for liquid markets, portfolio monitoring, and investment workflow automation.
        </p>
        <div className="flex flex-wrap gap-3">
          <a
            href="https://github.com/ErebusCipher"
            target="_blank"
          ...
          <a
            href="mailto:available-on-request@example.com"
